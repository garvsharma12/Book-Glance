...
- Name: Simple E2E Tests >> should be able to visit google
- Location: /home/grv/Downloads/ShelfScanner-main/tests/e2e/simple.spec.ts:4:3

# Error details

```
Error: browserType.launch: Executable doesn't exist at /home/grv/.cache/ms-playwright/chromium_headless_shell-1169/chrome-linux/headless_shell
╔═════════════════════════════════════════════════════════════════════════╗
